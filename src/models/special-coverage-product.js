...
class SpecialCoverage extends Product {
  constructor(sellIn, price) {
    if (price > MAX_PRODUCT_PRICE || price < MIN_PRODUCT_PRICE)
      throw Error("Invalid arguments");
    super(PRODUCT_TYPES.SPECIAL_FULL_COVERAGE, sellIn, price);
  }
  ...
  _updatePrice() {
    ...
    if (this.sellIn > 0 && this.sellIn <= 5) {
      ...
      this.price = this._getValidMaxPrice(this.price + 1);
    }
  }
